...
<body class="bg-c-main-color text-c-main-text-color font-['Comfortaa'] leading-[1.6] relative overflow-x-hidden w-full">
    ...
    <div class="bg-[#18435f] w-[100vw] md:w-[0px] h-[100vh] fixed left-0 top-[-100vh] z-[4] flex flex-col items-center justify-center gap-[20px]" id="menu">
        ...
        <a class="text-3xl menu-links p-[10px] border-solid border-[1px] border-c-call-to-action-color" href="">Resume</a>
    ...
    <div class="z-[0] opacity-[0] fixed top-0 left-0 bg-[#18435f88] w-full h-[100vh] transition-opacity duration-[0.4s]" id="contact">
        ...
        <div class="w-[90%] h-[75vh] mx-auto my-[12.5vh] flex flex-col items-center justify-evenly gap-[20px] bg-[#18435f]">
            ...
            <div class="flex flex-col items-center justify-center gap-[20px] md:w-[80%] md:max-w-[1000px]">
    ...
    <main class="relative z-[1] h-0 overflow-hidden animate-start_site_main">
        <!-- hero -->
        <div class="flex flex-col justify-center w-[80%] mx-auto md:w-[70%] md:ml-[5%] gap-[15px] h-[calc(100vh-70px)]">
        ...
        <div class="main">
            ...
            <!-- About me -->
            <div id="about"class="flex w-[90%] mx-auto items-center gap-[calc(calc(50%-500px)/2)] lg:flex-row sm:flex-col">
            ...
            <!-- projects -->
            <div id="projects" class="flex flex-col w-[90%] mx-auto mt-[100px]">
                ...
                <div class="flex flex-col gap-[120px] mt-[100px]">
                    ...
                    <div class="project project-odd">
                        ...
                        <div class="project-info animation-right">
                            ...
                            <div class="project-description">A minimal, dark blue theme for VS Code, Sublime Text, Atom, iTerm, and more. Available on Visual Studio Marketplace, Package Control, Atom Package Manager, and npm.</div>
                            <div class="project-stack">HTML CSS Laravel AlpineJS JavaScript PHP TailwindCSS</div>
                            <div class="project-link">link</div>
                        </div>
                    </div>
                    <!-- End project odd -->
            ...
            <!-- Contact -->
            <div id="contact-sec" class="w-[90%] mx-auto mt-[100px] flex flex-col justify-center items-center gap-[20px] md:items-start">
                <div class="font-[Audiowide] text-2xl md:text-5xl lg:text-7xl text-c-main-headers-color mt-[12px] text-center lg:text-left">
                    Get In Touch
                </div>
            ...
            <!-- footer -->
            <div class="w-[90%] mx-auto flex flex-col justify-center items-center gap-[20px] mt-[100px] mb-[30px]">
                <div class="text-sm">
